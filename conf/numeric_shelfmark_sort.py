...
input_filename = "${buildout:directory}/mysite/books/sql/shelfmarks_alpha_sort.txt" 
output_filename = "${buildout:directory}/mysite/books/sql/shelfmarks_numeric_sort.sql" 
